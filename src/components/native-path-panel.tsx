...
export function NativePathPanel() {
  const steps = [
    ...
    [RadioTower, 'SLEDGE bridge', 'Arbitrates safety, maps 17 → 24 and renders effects.'],
  ...
  return <section className="panel native-panel" id="native">
    ...
    <p className="lede">SLEDGE does not invent a second color picker when Steam can provide the real one. The shim exposes the interface Game Mode expects; the bridge translates that output to your 24 physical LEDs.</p>
