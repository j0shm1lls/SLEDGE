...
body{font:16px system-ui;background:#0b0c10;color:#f4f7fb;max-width:820px;margin:auto;padding:24px}h1{margin-bottom:4px}p{color:#9aa6b5;line-height:1.5}.card{background:#13151c;border:1px solid #2a2e3a;border-radius:12px;padding:18px;margin:16px 0}.grid{display:grid;grid-template-columns:1fr 1fr;gap:14px 20px}.row{display:flex;justify-content:space-between;gap:18px;padding:10px 0;border-bottom:1px solid #252935}.row:last-child{border:0}code{color:#8cc7ff}button,input,select{min-height:52px;font:inherit}input,select{box-sizing:border-box;width:100%;background:#0b0c10;color:#f4f7fb;border:1px solid #343947;border-radius:8px;padding:0 12px}input[type=color]{padding:5px}input[type=checkbox]{width:24px;min-height:24px}button{background:#4aa3ff;border:0;border-radius:8px;padding:0 18px;font-weight:700}label{display:grid;gap:7px;margin:6px 0}.check{display:flex;align-items:center;gap:10px;min-height:52px}.hint{font-size:13px;color:#7f8a9c}@media(max-width:640px){.grid{grid-template-columns:1fr}}</style></head><body>
