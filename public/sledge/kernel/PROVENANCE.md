...
Upstream SPDX license: **GPL-2.0+**. SLEDGE preserves that license boundary.
The SLEDGE Python daemon and web preview are separate works and do not link
against the kernel module.

SLEDGE modifications are limited to naming/comments, simplified logging, and
